...
ifeq ($(config),debug)
  ...
  RESCOMP = windres
  TARGETDIR = bin/Debug
  TARGET = $(TARGETDIR)/particels_box
  OBJDIR = obj/Debug
  DEFINES += -DDEBUG
  INCLUDES += -Ilib/GLFW/Include -Ilib/linmath -Ilib/glad/include -IVector2 -Iimgui -Iimgui/backends
  FORCE_INCLUDE +=
...
$(OBJDIR)/Vector2.o: Vector2/Vector2.cpp
	@echo $(notdir $<)
...
$(OBJDIR)/imgui_widgets.o: imgui/imgui_widgets.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/egl.o: lib/glad/src/egl.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/gl.o: lib/glad/src/gl.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
